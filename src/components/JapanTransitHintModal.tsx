          ...
          <div key={`${station.name}-${i}`}>
            <p className="font-medium text-ink-900">
              ...
              {station.lines.map((line) => (
                <span
                  key={line}
                  className="ml-1.5 rounded-full bg-paper-alt px-2 py-0.5 text-xs font-normal text-ink-700"
                >
                  {line}
                </span>
              ))}
            ...
            <div className="space-y-4">
              ...
              {externalUrl && (
                <a
                  ...
                  className="flex items-center justify-center gap-2 rounded-lg border border-line py-2 text-brand-600 hover:bg-paper-alt"
                >
